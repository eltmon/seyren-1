...
describe('check page', function () {
    ...
    it('should have a \'Details\' informations', function () {
        expect(element('div.col-lg-6 div.col-lg-10').count()).toBe(14);
        ...
        expect(element('div.col-lg-6 div.detail-form:eq(5) label').text()).toBe('Priority:');
        expect(element('div.col-lg-6 div.detail-form:eq(5) p span:visible').text()).toBe('MAJOR');

        expect(element('div.col-lg-6 div.detail-form:eq(6) label').text()).toBe('From:');
        expect(element('div.col-lg-6 div.detail-form:eq(7) p').text()).toBe('');

        expect(element('div.col-lg-6 div.detail-form:eq(7) label').text()).toBe('Until:');
        expect(element('div.col-lg-6 div.detail-form:eq(7) p').text()).toBe('');

        expect(element('div.col-lg-6 div.detail-form:eq(8) label').text()).toBe('Warn:');
        expect(element('div.col-lg-6 div.detail-form:eq(8) p').text()).toBe('0.5');

        expect(element('div.col-lg-6 div.detail-form:eq(9) label').text()).toBe('Error:');
        expect(element('div.col-lg-6 div.detail-form:eq(9) p').text()).toBe('2.0');

        expect(element('div.col-lg-6 div.detail-form:eq(10) label').text()).toBe('Enabled:');
        expect(element('div.col-lg-6 div.detail-form:eq(10) p input:checked').val()).toBe('on');

        expect(element('div.col-lg-6 div.detail-form:eq(11) label').text()).toBe('Live:');
        expect(element('div.col-lg-6 div.detail-form:eq(11) p input:not(:checked)').val()).toBe('on');

        expect(element('div.col-lg-6 div.detail-form:eq(12) label').text()).toBe('Allow no data:');
        expect(element('div.col-lg-6 div.detail-form:eq(12) p input:not(:checked)').val()).toBe('on');

        expect(element('div.col-lg-6 div.detail-form:eq(13) label').text()).toBe('Last check:');
        expect(element('div.col-lg-6 div.detail-form:eq(13) p').text()).toMatch('[0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}:[0-9]{2}');
    });
